...
public class CartPage extends BasePage{
	...
	public boolean isProductPresent(String[] inputProducts) {		
		...
		for (String name : inputProducts) {
			if (!driver.findElements(By.xpath("//table[@id='cart_info_table']/tbody/tr/td[2]/h4/a[text()='" + name + "']")).isEmpty()) {
	...
	public CartPage enterSubscriptionEmail(String email) {
		try {
			...
			log.info("Unable to enter '" + email + "' text in the subscription email text box. Error occured : " + e.getMessage());
			return this;
		}
	}
	...
	public CartPage scrollToFooter() {
		try {
			((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView();", waitForElementToBeVisible(lblSubscription));
	...
	public String getProductPrice(String productName) {
		try {
			String xpathString = "//table[@id='cart_info_table']/tbody/tr/td[2]/h4/a[text()='" + productName + "']/ancestor::td/following-sibling::td[@class='cart_price']";
	...
	public String getProductQuantity(String productName) {
		try {
			String xpathString = "//table[@id='cart_info_table']/tbody/tr/td[2]/h4/a[text()='" + productName + "']/ancestor::td/following-sibling::td[@class='cart_quantity']/button";
			WebElement element = waitForElementToBeVisible(By.xpath(xpathString));
	...
	public String getProductTotalAmount(String productName) {
		try {
			String xpathString = "//table[@id='cart_info_table']/tbody/tr/td[2]/h4/a[text()='" + productName + "']/ancestor::td/following-sibling::td[@class='cart_total']/p[@class='cart_total_price']";
			WebElement element = waitForElementToBeVisible(By.xpath(xpathString));
	...
	public CartPage removeProduct(String productName) {
		try {
			String xpathString = "//table[@id='cart_info_table']/tbody/tr/td[2]/h4/a[text()='" + productName + "']/ancestor::td/following-sibling::td[@class='cart_delete']/a[@class='cart_quantity_delete']";
			WebElement element = waitForElementToBeVisible(By.xpath(xpathString));
...
//		boolean flag = false;
		...
		for (String productName : productNames) {
			if (!driver.findElements(By.xpath("//table[@id='cart_info_table']/tbody/tr/td[2]/h4/a[text()='" + productName + "']")).isEmpty()) {
				foundProducts.add(productName);
				WebElement element = waitForElementToBeVisible(By.xpath("//table[@id='cart_info_table']/tbody/tr/td[2]/h4/a[text()='" + productName + "']/ancestor::td/following-sibling::td[@class='cart_delete']/a[@class='cart_quantity_delete']"));
				element.click();
