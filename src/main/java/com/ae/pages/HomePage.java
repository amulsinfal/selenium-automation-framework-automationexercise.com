...
//		return this;
	...
	public ProductDetailsPage clickViewProduct(String productName) {
		try {
			...
			Actions action = new Actions(driver);
			action.moveToElement(driver.findElement(By.xpath("//div[@class='productinfo text-center']/p[text()='" + productName + "']/ancestor::div[@class='single-products']//following-sibling::div[@class='choose']/descendant::a"))).perform();
			log.info("Hovering over the product : " +productName);
			driver.findElement(By.xpath("//div[@class='productinfo text-center']/p[text()='" + productName + "']/ancestor::div[@class='single-products']//following-sibling::div[@class='choose']/descendant::a")).click();
			log.info("Clicking on the view product link of product : " +productName);
			return new ProductDetailsPage(driver);
		} catch (Exception e) {
			log.info("Unable to click on the view product link of product : " +productName + ". Error occured : " +e.getMessage());
			return null;
		}
	}
